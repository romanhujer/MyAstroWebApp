...
def generate_jupiter():
    ...
    earth = eph['earth']
    jupiter = eph['jupiter barycenter']   # tohle v de440s.bsp JE
    ...
    with open("jupiter_ephemeris.json", "w", encoding="utf-8") as f:
        json.dump(result, f, indent=2, ensure_ascii=False)

    print("Hotovo: jupiter_ephemeris.json vygenerován.")
